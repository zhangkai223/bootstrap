...
<form>
  <div class="form-group mb-3">
    ...
    <select class="form-select mt-2" id="selectToastPlacement">
      ...
      <option value="top-50 left-0 translate-middle-y">Middle left</option>
      <option value="top-50 left-50 translate-middle">Middle center</option>
      <option value="top-50 right-0 translate-middle-y">Middle right</option>
...
<div aria-live="polite" aria-atomic="true" class="position-relative">
  ...
  <!-- - `.position-absolute`, `top-0` & `right-0` to position the toasts in the upper right corner -->
  <!-- - `.p-3` to prevent the toasts from sticking to the edge of the container  -->
  <div class="toast-container position-absolute top-0 right-0 p-3">
